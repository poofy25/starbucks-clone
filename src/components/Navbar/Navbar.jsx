        ...
        >
          ...
          <div className='flex justify-between w-full items-center h-full '>
            ...
            <div className="gap-[20px] items-center justify-end flex-1 text-white flex">
              ...
              <Link
                className="hidden fixed bottom-[15px] right-[15px] bg-brand_red p-[10px] rounded-full
                tablet:flex
                "
                href={button2.href}
              >
                <svg className='w-[20px] h-[20px]' fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 282 282"><g clip-path="url(#telephone-call_74451 1__a)"><path d="m260.274 233.335-39.359-49.946c-5.515-6.983-15.642-8.18-22.605-2.673l-15.174 11.958c-7.007 5.508-36.986 8.668-67.398-29.893-30.397-38.564-20.79-66.63-13.822-72.136l15.171-11.964c6.985-5.495 8.188-15.619 2.688-22.609L80.405 6.133C74.897-.852 64.767-2.045 57.77 3.454c0 0-15.44 12.213-15.577 12.331-21.357 17.616-29.09 47.681-21.767 84.908 6.327 32.161 23.58 67.307 48.518 98.969 24.979 31.649 55.121 56.621 84.931 70.276 34.908 16.031 66.299 15.327 88.441-1.942.031-.031.074-.062.104-.088l15.174-11.958c7.008-5.509 8.194-15.627 2.68-22.615Z" fill="#fff"/></g><defs><clipPath id="telephone-call_74451 1__a"><path fill="#fff" d="M0 0h281.475v281.475H0z"/></clipPath></defs></svg>
              </Link>
            </div>
          </div>
        </nav>
